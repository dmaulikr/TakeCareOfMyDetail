...
class PlayerTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let fruit1 = Fruit(name: "apple", price: 1000, color: "red")
        let fruit2 = Fruit(name: "tomato", price: 500, color: "red")
        let fruit3 = Fruit(name: "watermelon", price: 10000, color: "red")
